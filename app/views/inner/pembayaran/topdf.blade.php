...
<body>
    ...
    <div class="kuitansi" style="width:794px ">
       <div class="row" >
         ...
         <div style="left:10px; top: 80px;  margin-top: 10px; position:fixed; width:720px; font-size:12px; color:#11386b">Telah terima dari: {{$siswa->nama}}</div>
 ...
 <div class="kuitansi" style="width:794px ">
    ...
    <div style="width:790px;border-top:3px solid #a03737; padding:10px 0; position:fixed; top:85px"></div>
     <div style="left:10px; top: 80px;  margin-top: 10px; position:fixed; width:720px; font-size:12px; color:#6b1111">Telah terima dari: {{$siswa->nama}}</div>
     ...
     <div style="background-color:#e69696; position:fixed; padding: 5px 10px; left:20px; width:90px; top: 185px; font-size:14px; color:#6b1111" class="text-center">Lembar Untuk Bimbel</div>
